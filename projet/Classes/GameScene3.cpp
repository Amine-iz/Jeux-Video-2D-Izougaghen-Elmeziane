...
bool GameScene3::init()
{
    ...
    auto backgroundSprite = Sprite::create("terre3.png");
    backgroundSprite->setPosition(Point(visibleSize.width / 2 + origin.x, visibleSize.height / 2 + origin.y));
    this->addChild(backgroundSprite);

    auto edgebody = PhysicsBody::createEdgeBox(visibleSize, PHYSICSBODY_MATERIAL_DEFAULT, 3);
    auto edgeNode = Node::create();
    edgeNode->setPosition(Point(visibleSize.width / 2 + origin.x, (visibleSize.height / 2) + 205 + origin.y));
    ...
    void addObstacle2(float dt); {
        ...
        addObstacle2->setPosition(Point(visibleSize.width/2, visibleSize.height / 2 + origin.y));
    ...
    void addObstacle3(float dt); {
        ...
        addObstacle3->setPosition(Point(visibleSize.width - 10 , visibleSize.height / 2 + origin.y));
    ...
    void addObstacle1(float dt); {
        auto addObstacle1 = Sprite::create("key.png");
        addObstacle1->setPosition(Point(visibleSize.width, visibleSize.height / 2 + origin.y));
    ...
    auto playItem = MenuItemFont::create("Menu", CC_CALLBACK_1(GameScene3::GoToMenuScene, this));
...
void GameScene3::GoToMenuScene(cocos2d::Ref* sender)
{
